# Organic Chemistry — Exam Solutions
...
Both reactions involve **aryl diazonium salts**.
...
# **(c) Coupling Reaction and Sulfa Drug**

### **Coupling Reaction**

Aryl diazonium salts undergo electrophilic coupling with activated aromatic compounds such as **phenols and aromatic amines**, producing highly coloured **azo compounds**.
...
**Importance:** Azo compounds are widely used as **dyes and indicators**.

### **Connection with Sulfa Drugs — Prontosil**
...
# **(e) Curtius Degradation**

Curtius degradation converts a **carboxylic acid into a primary amine containing one carbon atom less** through an acid azide and isocyanate intermediate.
...
Amino acids that cannot be synthesized sufficiently by the human body and therefore must be obtained through the diet are called **essential amino acids**.

**Examples:** Leucine, lysine, valine, methionine, tryptophan.

---

### **Non-essential Amino Acid**

Amino acids that can be synthesized by the human body are called **non-essential amino acids**.
...
End-group analysis is used to determine the **N-terminal and C-terminal amino acids** of a peptide.

## **N-terminal analysis — Sanger Method**
...
Another important method is **Edman degradation**, which uses phenyl isothiocyanate (PITC) to identify and remove the N-terminal amino acid sequentially.

## **C-terminal analysis**

The C-terminal amino acid can be identified using **carboxypeptidase**, an enzyme that selectively hydrolyses the peptide bond at the C-terminal end.

Therefore, end-group analysis helps determine the **terminal amino acids and ultimately the sequence of a peptide**.
...
For controlled peptide synthesis, the amino group is protected and the carboxyl group is activated using a coupling reagent.
...
### Step 2: Activate the carboxyl group using DCC
...
**Important:** DCC is preferred here as the coupling reagent rather than converting Boc-Gly to an acid chloride, because strong acid generated during acid-chloride formation can cause problems with an acid-labile Boc protecting group and peptide coupling can also lead to racemization/side reactions.
...
**Essential amino acids must be supplied through the diet, whereas non-essential amino acids can be synthesized by the body.**

---

# **Last-Minute Revision — Memorize These**
...
**1°** → soluble sulphonamide in alkali
**2°** → insoluble sulphonamide
**3°** → no reaction with Hinsberg reagent
