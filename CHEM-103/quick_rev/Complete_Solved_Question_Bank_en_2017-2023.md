...
*Compiled from the uploaded scanned question papers (2017–2023). All parts (A) and (B), and every sub-question, are solved below, organized year by year, most recent first. Where the scan was ambiguous, this is flagged explicitly.*
...
E.g. D-glyceraldehyde → (HCN, then hydrolysis, then reduction) → D-erythrose + D-threose (epimeric pair, 4C). *(Each application adds one carbon; a second application on a 4C aldose such as D-erythrose gives the 5C pair D-ribose/D-arabinose.)*

![Kiliani-Fischer synthesis](../../assets/kiliani-fischer-synthesis.svg)
...
3. Couple with alanine (free amino group attacks the activated carbonyl): Boc–Gly–OH(activated) + H₂N–CH(CH₃)–COOH → Boc–Gly–NH–CH(CH�3)–COOH
...
*(See 2023-Q1(b) for the full mechanistic derivation.)* SN2: a single concerted transition state, Nu⁻ attacking as X⁻ leaves — Rate = k[RX][Nu⁻], one kinetic/mechanistic step. SN1: ionisation (RX → R⁺ + X⁻, slow) followed by a separate, fast combination step (R⁺ + Nu⁻ → RNu) — two distinct mechanistic steps, with the rate-determining first step giving Rate = k[RX].

##### (c) Discuss about electrophilic and nucleophilic addition reaction. [3]
*(See 2023-Q1(c).)* Electrophilic addition occurs at electron-rich π-bonds (alkenes/alkynes) attacked by an electrophile, e.g. CH₂=CH₂ + Br₂ → CH₂Br–CH₂Br via a bromonium-ion intermediate. Nucleophilic addition occurs at the electron-poor carbonyl carbon attacked by a nucleophile, e.g. CH₃CHO + NaHSO₃ → CH₃CH(OH)SO₃Na (bisulfite addition compound).

##### (d) Show that E₂ reaction is first order but E₁ 2nd order reaction. [3]
[**Scanned text unclear/likely reversed** — mechanistically E1 is first-order and E2 is second-order; answered according to correct chemistry, noting the paper's apparent labelling swap.]
...
**(i) Cannizzaro reaction:** self-disproportionation of an aldehyde with no α-H under conc. alkali into one molecule of alcohol and one of carboxylate salt (see 2023-Q3(c)).
...
*(See 2023-Q3(d) table.)* Key test: Tollens'/Fehling's/Schiff's — positive for aldehydes (they are easily oxidised, having an aldehydic H), negative for ketones.
...
- **Lucas test / oxidation** further classify as 1°/2°/3° (see 2023-Q2(d)).
...
**Hinsberg's method** (see 2023-Q5(d)): treat the mixture with benzenesulfonyl chloride and KOH.
...
![Evidence for the cyclic structure of D-glucose](../../assets/glucose-cyclic-structure-evidence.svg)
![Mutarotation of D-glucose](../../assets/glucose-mutarotation.svg)
![alpha-D-glucopyranose Haworth projection](../../assets/glucose-alpha-haworth.svg)
![beta-D-glucopyranose Haworth projection](../../assets/glucose-beta-haworth.svg)
...
![D-glucose vs D-fructose comparison](../../assets/glucose-vs-fructose.svg)
...
![Cellulose structure — beta-1,4-linked D-glucose units](../../assets/cellulose-structure.svg)
...
![Formation of a glycosidic linkage](../../assets/glycosidic-linkage.svg)
![Reducing vs non-reducing sugars](../../assets/reducing-vs-nonreducing-sugar.svg)
...
*(See 2023-Q2(d), Lucas test table.)* 3° alcohol → turbid immediately; 2° alcohol → turbid in 5–10 min; 1° alcohol → no turbidity in the cold (needs heating), because the test relies on relative carbocation stability during the SN1-type reaction of the alcohol with ZnCl₂/HCl.
...
*(See 2023-Q4(d).)* Converts an amide (RCONH₂) to a primary amine (RNH₂) with loss of one carbon, using Br₂/NaOH, via an isocyanate intermediate formed by migration of R from carbonyl carbon to nitrogen.
...
##### (c) How will you separate 1°, 2° and 3° amine from the mixture of amines? [3]
*(See 2022-Q5(c), Hinsberg's method.)*
...
![Lobry de Bruyn-van Ekenstein rearrangement: glucose to fructose](../../assets/glucose-to-fructose.svg)
...
![Sucrose structure — both anomeric carbons marked](../../assets/sucrose-structure.svg)
...
![Oxidation of D-glucose by bromine water](../../assets/glucose-oxidation-bromine-water.svg)
...
*(See 2023-Q6(d): Strecker synthesis and phthalimidomalonic ester synthesis.)*

##### (c) Explain end group analysis of peptide. [4]
*(See 2023-Q7(c): Sanger's/Edman's method for N-terminal; hydrazinolysis/Akabori method for C-terminal.)*
...
*(See 2023-Q2(c).)* RMgX + HCHO → 1° alcohol; RMgX + R′CHO → 2° alcohol; RMgX + R′COR″ → 3° alcohol (all followed by aqueous acidic work-up).
...
*(See 2023-Q4(a).)* Tetraethyl lead, Pb(C₂H₅)₄, an anti-knock additive formerly used in petrol; decomposes to lead and ethyl radicals in the cylinder, suppressing pre-ignition knocking; discontinued due to toxicity.
...
**Salicylic acid** — via the Kolbe–Schmitt reaction (see 2021-Q3(c)ii): sodium phenoxide + CO₂ (4–7 atm, 125 °C) → sodium salicylate → (H⁺) → salicylic acid.
...
*(See 2021-Q3(d).)* Double dehydration gives acrolein (CH₂=CH–CHO), recognised by its sharp, acrid odour.
...
*(See 2023-Q3(d).)* Tollens'/Fehling's/Schiff's reagent — positive (silver mirror/red ppt./pink colour) for aldehydes, negative for ketones, since ketones lack the readily oxidisable aldehydic hydrogen.
...
*(See 2022-Q7(a): mono-, oligo-/di-, and polysaccharides, by hydrolysis behaviour, plus aldose/ketose classification.)*

##### (b) Give the evidence of the cyclic-structure of D-Glucose. [4]
*(See 2022-Q7(b): failure of typical aldehyde reactions, mutarotation, existence of two anomers, pentaacetate formation.)*
...
Using the **Strecker synthesis** (see 2023-Q6(d)) with three different aldehydes:
...
*(See 2022-Q3(d).)* Zn-mediated coupling of an α-haloester with an aldehyde/ketone to give a β-hydroxy ester, via an in-situ organozinc enolate: RCHO + BrCH₂COOC₂H₅ →(Zn) RCH(OH)CH₂COOC₂H₅.

#### Question 2

##### (a) Why is phenol acidic in nature? [3]
*(See 2020-Q2(a).)* Resonance delocalisation of the negative charge of phenoxide into the aromatic ring stabilises the conjugate base, enhancing acidity relative to alcohols.

##### (b) Write down with reaction how to differentiate between phenol and ethanol. [3]
*(See 2022-Q4(b).)* **FeCl₃ test:** phenol gives a violet/purple colouration with neutral FeCl₃ (forms a coloured iron–phenolate complex); ethanol gives no colouration.
...
*(See 2023-Q3(d).)* Tollens'/Fehling's test positive for acetaldehyde (has an oxidisable aldehydic H), negative for acetone.
...
*(See 2022-Q5(c) header context / 2020-Q6(c)).* The **N-terminal residue** is the amino acid at the end of a peptide/protein chain bearing a free (unreacted) α-amino group (–NH₂); the **C-terminal residue** is the amino acid at the end bearing a free (unreacted) carboxyl group (–COOH). By convention, peptide sequences are written from the N-terminus to the C-terminus.

##### (b) How are α-amino acid prepared? [2]
*(See 2023-Q6(d): Strecker synthesis, phthalimidomalonic ester synthesis.)*
...
![Starch vs cellulose comparison](../../assets/starch-vs-cellulose.svg)
...
*(See 2023-Q1(c).)* Electron-rich π-bond (e.g. of an alkene) is attacked by an electrophile E⁺, forming a carbocation intermediate (or bridged ion, e.g. bromonium ion with Br₂), which is then captured by a nucleophile, e.g. CH₂=CH₂ + HBr → CH₃CH₂Br (via a 2° or more-stable carbocation, per Markovnikov's rule for unsymmetrical alkenes).
...
**(i) Picric acid (2,4,6-trinitrophenol):** prepared by sulfonation of phenol followed by nitration (see 2020-Q2(b)); a yellow, strongly acidic (comparable to a mineral acid, due to three –NO₂ groups strongly stabilising the phenoxide anion by resonance/induction) crystalline solid; used historically as a yellow dye, an antiseptic, and (being shock-sensitive) as a military explosive.
**(ii) TNG (trinitroglycerine / nitroglycerine):** prepared by nitrating glycerol with a mixture of concentrated HNO₃ and H₂SO₄ (see 2022-Q4(c)):
$$C_3H_5(OH)_3 + 3HNO_3 \xrightarrow{conc.\,H_2SO_4} C_3H_5(ONO_2)_3 + 3H_2O$$
...
*(See 2020-Q8(d): zwitterion, H₃N⁺–CHR–COO⁻.)*
...
**(i) Coupling reaction:** *(see 2021-Q3(c)i)* diazonium salt + phenol/amine at 0–5°C gives an azo compound.
...
*(See 2021-Q5(d)i.)* By diazotisation: aniline + NaNO₂ + 2HCl at 0–5°C → C₆H₅N₂⁺Cl⁻ + NaCl + 2H₂O.
...
**(ii) Hofmann degradation of amides:** *(see 2023-Q4(d))* RCONH₂ + Br₂ + 4NaOH → RNH₂ + 2NaBr + Na₂CO₃ + 2H₂O, converting an amide to a primary amine with one fewer carbon, via an isocyanate intermediate formed by 1,2-migration of R from carbon to the electron-deficient nitrogen.
...
**(i) Coupling reaction:** *(see 2021-Q3(c)i).*
**(ii) Reimer–Tiemann reaction:** *(see 2020-Q4(d)ii)* phenol + CHCl₃/conc. NaOH, via a dichlorocarbene intermediate, gives (after hydrolysis) salicylaldehyde (o-hydroxybenzaldehyde) as the major product.

##### (d) Distinguish among, 1°, 2° and 3° alcohol? [3]
*(See 2023-Q2(d): Lucas test and oxidation test.)*
...
*(See 2023-Q6(d): Strecker synthesis; Gabriel-phthalimidomalonic ester synthesis.)*

##### (b) Describe identification of N and C-terminal amino acid residues. [5]
*(See 2023-Q6(c): Sanger's DNFB method for N-terminal; hydrazinolysis/Akabori method for C-terminal.)*

##### (c) What is iso-electric pH of amino acid? [3]
*(See 2023-Q6(e): pI, the pH at which the amino acid exists as the neutral zwitterion with zero net charge; for a simple neutral amino acid, pI = (pKa1 + pKa2)/2.)*
...
**(i) Benzene diazonium chloride:** by diazotisation of aniline — *(see 2021-Q5(d)i)*: C₆H₅NH₂ + NaNO₂ + 2HCl →(0–5°C) C₆H₅N₂⁺Cl⁻ + NaCl + 2H₂O.
**(ii) Azo compound:** by coupling the diazonium salt with an activated aromatic ring (phenol or amine) at low temperature — *(see 2021-Q3(c)i)*: C₆H₅N₂⁺Cl⁻ + C₆H₅NH₂ → C₆H₅–N=N–C₆H₄–NH₂ (p-aminoazobenzene) + HCl.
...
|---|---|---|---|---|---|---|---|---:|
| Electronic effects (inductive/electromeric/mesomeric/hyperconjugation) | ✓ | ✓ | – | – | ✓ | ✓ | ✓ | 5 |
| SN1/SN2 order & mechanism | ✓ | ✓ | – | – | ✓ | ✓ | ✓ | 5 |
| E1/E2 order & mechanism | ✓ | – | – | ✓ | ✓ | ✓ | – | 4 |
| Electrophilic/nucleophilic addition | ✓ | ✓ | – | – | ✓ | ✓ | ✓ | 5 |
| Grignard reagent / organometallics | ✓ | – | ✓ | ✓ | – | ✓ | ✓ | 5 |
| TEL (tetraethyl lead) | ✓ | – | – | ✓ | – | ✓ | ✓ | 4 |
| Alcohol vs phenol / 1°,2°,3° alcohol distinction | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | 7 |
| Coupling reaction | ✓ | ✓ | – | – | ✓ | – | ✓ | 4 |
| Reimer–Tiemann / Kolbe reaction | ✓ | – | – | ✓ | ✓ | – | – | 3 |
| Aldehyde vs ketone (reactivity & distinction) | – | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | 6 |
| Cannizzaro reaction | ✓ | – | – | – | – | ✓ | ✓ | 3 |
| Rosenmund reduction | – | – | – | ✓ | – | – | ✓ | 2 |
| Aldol condensation / Haloform reaction | – | – | – | – | – | ✓ | – | 1 |
| Carboxylic acid derivatives / acidity comparison | – | ✓ | – | ✓ | ✓ | ✓ | ✓ | 5 |
| Hofmann degradation | – | ✓ | – | – | – | – | ✓ | 2 |
| Curtius degradation | – | – | – | – | – | – | ✓ | 1 |
| Sandmeyer / Gattermann reaction | – | ✓ | – | – | – | – | – | 1 |
| Amines: prep. & basicity (1°/2°/3°, aniline vs methylamine) | – | ✓ | – | – | ✓ | ✓ | ✓ | 4 |
| Hinsberg separation of amines | – | ✓ | – | – | ✓ | ✓ | – | 3 |
| Diazonium salts / azo compounds | ✓ | ✓ | – | – | ✓ | – | – | 3 |
| Carbohydrate classification | ✓ | – | – | ✓ | ✓ | ✓ | – | 4 |
| Cyclic structure of D-glucose / mutarotation | ✓ | – | – | ✓ | – | ✓ | – | 3 |
| Glucose vs fructose (Seliwanoff's) | – | ✓ | – | – | – | ✓ | – | 2 |
| Glucose vs sucrose / structure of sucrose | – | – | – | ✓ | ✓ | – | – | 2 |
| Starch vs cellulose / glycosides | – | ✓ | ✓ | – | – | ✓ | – | 3 |
| Amino acids: prep., zwitterion, pI | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | 7 |
| N/C-terminal end-group analysis | ✓ | – | ✓ | ✓ | ✓ | ✓ | ✓ | 6 |
| Peptide synthesis (Gly-Ala) | – | ✓ | – | – | – | – | ✓ | 2 |
| Chromophore & auxochrome / colour theory | ✓ | ✓ | – | ✓ | ✓ | ✓ | ✓ | 6 |
| Dye classification & dye intermediates | ✓ | ✓ | – | – | ✓ | ✓ | ✓ | 5 |
| Indigo (preparation & uses) | – | – | – | ✓ | – | – | ✓ | 2 |
| Non-textile uses of dyes | ✓ | ✓ | – | ✓ | ✓ | ✓ | ✓ | 6 |

---

# Must-Know Reactions

| Reaction | Reactants | Reagents / Conditions | Product | Significance |
|---|---|---|---|---|
| SN1 | R–X (esp. 3°) | polar protic solvent | R–Nu (racemised) | Two-step, first-order; carbocation intermediate |
| SN2 | R–X (esp. 1°) | strong Nu⁻, aprotic solvent | R–Nu (inverted) | One-step, second-order; back-side attack |
| E1/E2 | R–X + base | E1: weak base, polar solvent; E2: strong base | Alkene | Competes with SN1/SN2; asked almost every year |
| Grignard + HCHO/RCHO/R₂CO | RMgX | dry ether, then H₃O⁺ | 1°/2°/3° alcohol | Core route to alcohols; extremely high-yield topic |
| Rosenmund reduction | RCOCl | H₂, Pd/BaSO₄ (poisoned) | RCHO | Selective route to aldehydes |
| Cannizzaro reaction | Aldehyde with no α-H | conc. NaOH | Alcohol + carboxylate | Disproportionation, tests mechanism understanding |
| Aldol condensation | Aldehyde/ketone with α-H | dil. NaOH, then Δ | α,β-unsaturated carbonyl | Foundational C–C bond-forming reaction |
| Haloform reaction | CH₃CO–R or CH₃CH(OH)R | X₂/NaOH | CHX₃ + RCOONa | Diagnostic iodoform test |
| Kolbe–Schmitt | Sodium phenoxide | CO₂, 125°C, 4–7 atm | Salicylic acid | Key phenol → acid route |
| Reimer–Tiemann | Phenol | CHCl₃, NaOH | Salicylaldehyde | Dichlorocarbene mechanism |
| Coupling reaction | ArN₂⁺ + phenol/amine | 0–5°C | Azo compound | Basis of azo dye chemistry |
| Diazotisation | ArNH₂ | NaNO₂/HCl, 0–5°C | ArN₂⁺Cl⁻ | Gateway to diazonium chemistry |
| Sandmeyer / Gattermann | ArN₂⁺Cl⁻ | CuX (Sandmeyer) or Cu/HX (Gattermann) | ArX | Introduces halogen where EAS fails |
| Esterification (Fischer) | RCOOH + R′OH | conc. H₂SO₄, Δ | RCOOR′ + H₂O | Reversible; mechanism frequently asked |
| HVZ reaction | RCH₂COOH | Br₂, red P | RCHBrCOOH | α-halogenation of acids |
| Hofmann degradation | RCONH₂ | Br₂/NaOH | RNH₂ (–1 C) | Isocyanate intermediate |
| Curtius degradation | RCON₃ | Δ, –N₂; then H₂O | RNH₂ (–1 C) | Same isocyanate-type mechanism |
| Strecker synthesis | RCHO + NH₃ + HCN | then H₃O⁺ | α-amino acid | Standard amino-acid synthesis |
| Peptide (Gly-Ala) synthesis | Protected Gly + Ala | activation, coupling, deprotection | Dipeptide | Core of peptide chemistry |
| Kiliani–Fischer synthesis | Aldose | HCN, then hydrolysis/reduction | Next-higher aldose | Chain-extension of sugars |
| Lobry de Bruyn–van Ekenstein | Glucose | dilute alkali | Fructose (+mannose) | Aldose ⇌ ketose interconversion |
| Mutarotation | α-/β-D-glucose | dissolve in water | Equilibrium mixture | Evidence for cyclic structure |

---

## Mechanisms to Practice First

Ranked by frequency across years and marks typically allocated:

1. **SN1 vs SN2** (order derivation) — asked nearly every year, usually 3 marks.
2. **Grignard addition to carbonyls** (1°/2°/3° alcohol formation) — very high frequency, often the whole of Q2.
3. **Cannizzaro reaction mechanism** — asked with full mechanism marks (2017, 2022, 2023).
4. **Hofmann/Curtius degradation** — isocyanate-intermediate mechanism, recurring.
5. **Esterification (Fischer) mechanism** — 5-mark mechanism question in 2021.
6. **Reimer–Tiemann / Kolbe–Schmitt** — carbene/CO₂-insertion mechanisms.
7. **Diazotisation + coupling/Sandmeyer/Gattermann** — recurring across years.
8. **Strecker synthesis of amino acids** — recurring 2-method preparation question.
9. **Mutarotation / cyclic structure of glucose** — recurring evidence-based question.

---

# Chemistry Structure Sheet

| Compound | Formula / Structure | Key Functional Group | Important Reaction |
|---|---|---|---|
| Grignard reagent | R–MgX | C–Mg (organometallic) | Adds to carbonyls → alcohols |
| Acetaldehyde | CH₃CHO | Aldehyde | Cannizzaro (n/a, has α-H so undergoes aldol instead); Tollens' positive |
| Acetone | CH₃COCH₃ | Ketone | Iodoform test; aldol condensation |
| Phenol | C₆H₅OH | Aromatic –OH | Kolbe–Schmitt, Reimer–Tiemann, coupling |
| Aniline | C₆H₅NH₂ | Aromatic 1° amine | Diazotisation → diazonium salt |
| Benzene diazonium chloride | C₆H₅N₂⁺Cl⁻ | Diazonium | Coupling, Sandmeyer, Gattermann |
| Glucose | OHC–(CHOH)₄–CH₂OH (open) / pyranose (cyclic) | Aldohexose | Mutarotation, oxidation, osazone |
| Fructose | HOCH₂–CO–(CHOH)₃–CH₂OH (open) / furanose (cyclic) | Ketohexose | Seliwanoff's test positive |
| Sucrose | Glucose(α1↔2β)Fructose | Non-reducing glycoside | Hydrolysis → invert sugar |
| Cellulose | [C₆H₁₀O₅]ₙ, β-1,4-linked glucose | Polysaccharide | Textile fibre structural component |
| Indigo | Bis-indoxylidene (C₁₆H₁₀N₂O₂) | Vat dye chromophore | Leuco-reduction/re-oxidation dyeing |

---

# Chemistry-II Formula & Reaction Sheet

## Organic Reaction Mechanisms
- SN1: Rate = k[RX] (two-step, carbocation intermediate)
- SN2: Rate = k[RX][Nu⁻] (one-step, back-side attack, inversion)
- E1: Rate = k[RX] (two-step, via carbocation)
- E2: Rate = k[RX][Base] (one-step, concerted anti-periplanar elimination)

## Alcohols & Phenols
- Lucas test differentiates 1°/2°/3° alcohols by rate of turbidity (fastest for 3°).
- Kolbe–Schmitt: C₆H₅ONa + CO₂ →(125°C, 4–7 atm) salicylic acid (after acidification).
- Reimer–Tiemann: phenol + CHCl₃/NaOH → salicylaldehyde (via :CCl₂).

## Aldehydes & Ketones
- Cannizzaro: 2RCHO + NaOH → RCOONa + RCH₂OH (no α-H aldehydes only).
- Haloform: CH₃COR + 3X₂ + 4NaOH → CHX₃ + RCOONa + 3NaX + 3H₂O.
- Aldol: 2CH₃CHO →(dil. NaOH) CH₃CH(OH)CH₂CHO →(–H₂O, Δ) CH₃CH=CHCHO.

## Carboxylic Acids & Derivatives
- Fischer esterification: RCOOH + R′OH ⇌(conc. H₂SO₄) RCOOR′ + H₂O.
- Acidity order (inductive effect): ClCH₂COOH > CH₃COOH > C₂H₅COOH.
- HVZ reaction: RCH₂COOH + Br₂ →(red P) RCHBrCOOH + HBr.

## Amines
- Basicity: Kb = [RNH₃⁺][OH⁻]/[RNH₂]; pKb = –log Kb.
- Diazotisation: ArNH₂ + NaNO₂ + 2HCl →(0–5°C) ArN₂⁺Cl⁻ + NaCl + 2H₂O.
- Aniline < methylamine in basicity (resonance delocalisation of N lone pair into ring).

## Amino Acids & Proteins
- Zwitterion: H₃N⁺–CHR–COO⁻.
- pI (neutral amino acid) = (pKa1 + pKa2)/2.
- Strecker synthesis: RCHO + NH₃ + HCN → RCH(NH₂)CN →(H₃O⁺) RCH(NH₂)COOH.

## Carbohydrates
- Mutarotation: α-D-glucose (+113°) ⇌ β-D-glucose (+19°) → equilibrium (+52.5°).
- Kiliani–Fischer: aldose + HCN → cyanohydrin → hydrolysis/reduction → next-higher aldose.
- Lobry de Bruyn–van Ekenstein: glucose ⇌(dil. alkali, via enediol) fructose (+mannose).

![Carbohydrate reactions — overview sheet](../../assets/carbohydrate-reactions.svg)

## Dyes & Colour Chemistry
- Chromophore: unsaturated colour-bearing group (–N=N–, >C=O, –NO₂).
- Auxochrome: colour-deepening, solubilising group (–OH, –NH₂, –SO₃H).
- Diazo coupling: ArN₂⁺Cl⁻ + phenol/amine →(0–5°C) azo compound.

## Physical/Quantitative Relations
- First-order rate constant: k = (2.303/t) log([A]₀/[A]ₜ).
- pKb = –log Kb (amine basicity).
- pI = (pKa1 + pKa2)/2 (neutral amino acid isoelectric point).

---

# Definitions to Memorize

- **Inductive effect** — permanent polarisation of σ-bond electrons along a chain due to electronegativity differences.
- **Electromeric effect** — temporary, complete shift of a π-electron pair to one atom, occurring only with an attacking reagent.
- **Mesomeric effect** — permanent delocalisation of π/lone-pair electrons through a conjugated system (resonance).
- **Hyperconjugation** — no-bond resonance delocalisation of adjacent C–H σ-electrons into an empty/π orbital.
- **Electrophile** — an electron-deficient species that seeks electron-rich sites.
- **Nucleophile** — an electron-rich species (lone pair/negative charge) that attacks electron-deficient centres.
- **Grignard reagent** — an organomagnesium halide, R–MgX, prepared from RX and Mg in dry ether.
- **Organometallic compound** — any compound containing a direct carbon–metal bond.
- **Aldehyde** — a compound with the –CHO group (carbonyl bonded to at least one H).
- **Ketone** — a compound with the >C=O group bonded to two carbon substituents.
- **Phenol** — a compound with –OH directly attached to an aromatic ring carbon.
- **Amines** — derivatives of ammonia in which one or more H atoms are replaced by alkyl/aryl groups.
- **Amino acid** — a compound bearing both –NH₂ and –COOH groups (α-amino acid: both on the same carbon).
- **Zwitterion** — a neutral molecule bearing both a positive and negative charge on different atoms (e.g. H₃N⁺–CHR–COO⁻).
- **Isoelectric point (pI)** — the pH at which an amino acid exists as the neutral zwitterion (zero net charge).
- **Peptide** — a compound of two or more amino acids joined by peptide (amide) bonds.
- **Protein** — a large biopolymer of amino acids joined by peptide bonds, folded into 3-D structure.
- **Carbohydrate** — a polyhydroxy aldehyde or ketone (or a compound yielding these on hydrolysis).
- **Glycoside** — the mixed acetal formed between the anomeric –OH of a sugar and another –OH-bearing (or similar) group.
- **Chromophore** — an unsaturated group responsible for colour absorption.
- **Auxochrome** — a saturated, polar group that deepens colour and confers dye-fibre affinity.
- **Dye** — a coloured substance with substantivity for a fibre, applied from solution.
- **Pigment** — a coloured, insoluble solid dispersed (not dissolved/bonded) in a medium.

---

# Last-Minute Exam Preparation

## 1. Highest-Priority Topics (by frequency)
1. Alcohol/phenol distinction & reactions — appears in **all 7** years.
2. Amino acids (prep., zwitterion, pI) — appears in **all 7** years.
3. Aldehyde vs ketone distinction/reactivity — **6** years.
4. N/C-terminal end-group analysis — **6** years.
5. Chromophore/auxochrome & colour theory — **6** years.
6. Non-textile uses of dyes — **6** years.
7. Electronic effects, SN1/SN2, electrophilic/nucleophilic addition, Grignard chemistry, carboxylic-acid acidity/derivatives, dye classification — **5** years each.

## 2. Most Repeated Questions
- "Show that SN1 is first order / SN2 is second order" (and the E1/E2 analogue) — repeated almost verbatim across 5 papers.
- "Distinguish between 1°, 2°, 3° alcohols" (by Lucas reagent, dehydrogenation, or oxidation).
- "Why is aniline less basic than methylamine?" — repeated wording in 3 papers.
- "Chromophore and auxochrome" definition — repeated wording in nearly every paper.
- "Non-textile uses of dyes" — appears with nearly identical wording each year.
- N- and C-terminal residue identification — recurring almost every year.

## 3. Must-Memorize Reactions (priority order)
1. SN1/SN2/E1/E2 rate laws and mechanisms
2. Grignard synthesis of 1°/2°/3° alcohols
3. Cannizzaro reaction
4. Fischer esterification mechanism
5. Hofmann and Curtius degradation
6. Diazotisation, coupling, Sandmeyer/Gattermann reactions
7. Strecker synthesis of amino acids
8. Kolbe–Schmitt and Reimer–Tiemann reactions
9. Mutarotation and Lobry de Bruyn–van Ekenstein rearrangement

## 4. Must-Know Mechanisms
- SN1/SN2 and E1/E2 stepwise mechanisms with rate laws.
- Cannizzaro reaction (hydride-transfer mechanism).
- Fischer esterification (protonation → nucleophilic addition → proton transfer → elimination of water → deprotonation).
- Hofmann/Curtius degradation (isocyanate intermediate via 1,2-migration).

## 5. Must-Know Structures
- Grignard reagent (R–MgX), glucose (open-chain and pyranose forms), fructose (furanose form), sucrose (glycosidic linkage), cellulose (β-1,4-glucan), a dipeptide (Gly-Ala), benzene diazonium chloride, indigo.

## 6. Must-Memorize Definitions
See the "Definitions to Memorize" section above — focus especially on inductive/electromeric/mesomeric effect, chromophore/auxochrome, zwitterion/isoelectric point, and Grignard reagent/organometallic compound, as these appear as stand-alone definition sub-questions almost every year.

## 7. Last-Minute Revision Checklist
- [ ] Electronic effects: inductive, electromeric, mesomeric, hyperconjugation — definitions + one example each
- [ ] SN1/SN2/E1/E2 — mechanism, rate law, and which is favoured by which substrate/solvent
- [ ] Grignard reactions — preparation + reaction with HCHO/RCHO/ketone → 1°/2°/3° alcohol
- [ ] Alcohols and phenols — Lucas test, Kolbe–Schmitt, Reimer–Tiemann, coupling, dehydration to acrolein
- [ ] Aldehydes and ketones — Cannizzaro, aldol, haloform, Rosenmund, distinguishing tests
- [ ] Carboxylic acids — acidity order, esterification mechanism, HVZ reaction, acid derivatives
- [ ] Amines and diazonium salts — basicity order, Hinsberg separation, diazotisation, Sandmeyer/Gattermann, coupling
- [ ] Carbohydrates — classification, mutarotation, cyclic structure evidence, glucose vs fructose (Seliwanoff), sucrose structure, starch vs cellulose
- [ ] Amino acids — Strecker synthesis, zwitterion, pI formula, essential vs non-essential
- [ ] Peptides/proteins — peptide bond, N-/C-terminal analysis, dipeptide synthesis, protein classification
- [ ] Dyes — chromophore/auxochrome, Witt's/modern colour theory, dye classification, indigo prep, non-textile uses
- [ ] Important reactions — full list in "Must-Know Reactions" table above
- [ ] Important structures — full list in "Chemistry Structure Sheet" above
- [ ] Important formulas — rate laws (SN1/SN2/E1/E2), pKb, pI, first-order rate constant k

---

*End of solved question bank. All years (2017–2023), all Parts A and B, and all sub-questions from the uploaded scanned papers have been addressed above. Where a sub-question's wording repeated near-verbatim across years, a cross-reference to the fullest treatment is given rather than duplicating identical text, per good exam-prep practice — but every sub-question is accounted for.*
