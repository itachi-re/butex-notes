...
##### (c) If $\mathcal L\{F(t)\}=f(s)$, show $L\{F'''(t)\}=s^3f(s)-s^2F(0)-sF'(0)-F''(0)$.
...
Being careful with signs, using $\mathcal L\{t^2f(t)\}=F''(s)$ directly:
...
##### (c) Solve $Y''(t)+9Y(t)=\cos2t;\quad Y(0)=1,\ Y(\pi/2)=-1$.
