...
First integral (by parts): $\left[-\frac{te^{-st}}{s}\right]_0^1 + \frac{1}{s}\int_0^1 e^{-st}dt = -\frac{e^{-s}}{s} + \frac{1}{s}\left(\frac{1-e^{-s}}{s}\right)$

Second integral: $\left[-\frac{e^{-st}}{s}\right]_1^\infty = \frac{e^{-s}}{s}$
